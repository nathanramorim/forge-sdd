...
`sdd/.sdd-version = 1.6.0` para projetos criados com este documento.
...
6. Atualizar `.sdd-version` para `1.6.0`
...
**Forge-SDD v1.6.0** — Última atualização: 3 de julho de 2026
