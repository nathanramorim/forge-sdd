...
`sdd/.sdd-version = 1.5.2` para projetos criados com este documento.
...
6. Atualizar `.sdd-version` para `1.5.2`
...
**Forge-SDD v1.5.2** — Última atualização: 30 de maio de 2026
