...
`sdd/.sdd-version = 1.5.3` para projetos criados com este documento.
...
6. Atualizar `.sdd-version` para `1.5.3`
...
**Forge-SDD v1.5.3** — Última atualização: 30 de maio de 2026
