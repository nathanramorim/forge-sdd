...
`sdd/.sdd-version = 1.3.0` para projetos criados com este documento.
...
6. Atualizar `.sdd-version` para `1.3.0`
...
**Forge-SDD v1.3.0** — Última atualização: 30 de maio de 2026
