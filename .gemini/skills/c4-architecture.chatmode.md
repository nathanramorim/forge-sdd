...
- **Formato:** `graph LR` (Left-Right) ou `graph TB`.
- **Foco:** Responsabilidades tecnológicas e protocolos de comunicação.
...
- **Dica:** Use diagramas de sequência para o Nível 3 pois eles distribuem melhor as interações temporais do que fluxogramas complexos no Nível 3.
