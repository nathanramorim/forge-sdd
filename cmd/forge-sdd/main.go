...
// version é injetada via ldflags: -X main.version=1.8.1-beta
var version = "1.8.1-beta"
...
func init() {
	...
	initCmd.Flags().String("version", "", "Versão Forge-SDD (default: 1.8.1-beta)")
	...
	updateCmd.Flags().String("version", "", "Atualizar estrutura para uma versão específica (ex: 1.8.1-beta)")
