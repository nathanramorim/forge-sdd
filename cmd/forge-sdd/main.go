...
// version é injetada via ldflags: -X main.version=1.7.1-beta.3
var version = "1.7.1-beta.3"
...
func init() {
	...
	initCmd.Flags().String("version", "", "Versão Forge-SDD (default: 1.7.1-beta.3)")
	...
	updateCmd.Flags().String("version", "", "Atualizar estrutura para uma versão específica (ex: 1.7.1-beta.3)")
