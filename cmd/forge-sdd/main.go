...
// version é injetada via ldflags: -X main.version=1.7.1-beta.0
var version = "1.7.1-beta.0"
...
func init() {
	...
	initCmd.Flags().String("version", "", "Versão Forge-SDD (default: 1.7.1-beta.0)")
	...
	updateCmd.Flags().String("version", "", "Atualizar estrutura para uma versão específica (ex: 1.7.1-beta.0)")
