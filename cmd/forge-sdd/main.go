...
// version é injetada via ldflags: -X main.version=2.3.0
var version = "2.3.0"
...
func init() {
	...
	initCmd.Flags().String("version", "", "Versão Forge-SDD (default: 2.3.0)")
	...
	updateCmd.Flags().String("version", "", "Atualizar estrutura para uma versão específica (ex: 2.3.0)")
