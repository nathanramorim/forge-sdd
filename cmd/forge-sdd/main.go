...
// version é injetada via ldflags: -X main.version=1.7.1-beta.4
var version = "1.7.1-beta.4"
...
func init() {
	...
	initCmd.Flags().String("version", "", "Versão Forge-SDD (default: 1.7.1-beta.4)")
	...
	updateCmd.Flags().String("version", "", "Atualizar estrutura para uma versão específica (ex: 1.7.1-beta.4)")
